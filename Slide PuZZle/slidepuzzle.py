...
def getStartingBoard():
    ...
    # for example, if BOARDWIDTH and BOARDHEIGHT are both 3 , this fumcton
...
def getSpotClicked(board,x,y):
    # from the x & y pixel coordinates get the x and y board coordinates
...
def slideAnimation(board,direction,message,animationSpeed):
    ...
    # draw a blank space over the moving tile on the bassurf surface
    moveLeft, moveTop = getLeftTopOfTile(movex, movey)
    pygame.draw.rect(baseSurf, BGCOLOR, (moveLeft, moveTop, TILESIZE, TILESIZE))

    for i in range(0 ,TILESIZE, animationSpeed):
        # animate the tile slidimg over
        checkForQuit()
